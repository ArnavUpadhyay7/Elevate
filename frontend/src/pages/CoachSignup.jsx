...
const CoachSignup = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    rate: "", about: "", profilePic: "", coachBanner: "",
  });
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 py-14 relative overflow-y-auto">
        ...
        <div className="w-full max-w-sm relative">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-white/35 tracking-wide">Show others the path to success.</p>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">

            <Field label="Full Name">
              <input type="text" placeholder="Your in-game name" value={formData.fullname}
            ...
            <div className="flex gap-3">
              ...
              {/* Rank — starts at Diamond, climbs to Radiant */}
            ...
            <Field label="Rate per Session (₹)">
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[13px] text-white/25 pointer-events-none font-semibold">₹</span>
                <input type="number" placeholder="200" value={formData.rate}
            ...
            <Field label="About You">
              <textarea
                placeholder="Radiant coach with 2,000+ hours. Specialise in aim training and map control…"
            ...
            <Field label="Coach Banner URL (Optional)">
              <input type="text" placeholder="https://…" value={formData.coachBanner}
          ...
          <p className="text-center text-[12.5px] text-white/30 mt-5">
            ...
            <Link to="/coach-login" className="text-[#A01E2E] hover:text-[#C0242E] font-semibold transition-colors">
              Sign in
            </Link>
          </p>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden items-end">
        ...
        <div className="relative z-10 p-14 pb-16 max-w-sm">
          ...
          <h2 className="font-['Syne',sans-serif] font-extrabold text-3xl text-white tracking-tight leading-tight mb-3">
            Get your free coach account right now.
          </h2>
          <p className="text-[13px] text-white/40 leading-relaxed">
            Sign up to list your profile, connect with players, and start earning from your expertise.
          </p>
