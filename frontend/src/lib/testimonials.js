export const testimonials = [
    {
      quote: "This platform transformed my gaming experience! I improved my rank in no time.",
      name: "John Doe",
      designation: "Gold Player",
    ...
    {
      quote: "The coaches here are phenomenal! Their insights really made a difference.",
      name: "Jane Smith",
      designation: "Silver Player",
    ...
    {
      quote: "I never thought I could make it to Radiant, but with the right guidance, I did!",
      name: "Carlos Ruiz",
      designation: "Radiant Player",
    ...
    {
      quote: "Elevate helped me understand the game better, and my gameplay has improved dramatically.",
      name: "Anna Lee",
      designation: "Platinum Player",
    ...
    {
      quote: "Thanks to the coaching sessions, my strategy and aim have reached new heights!",
      name: "Ethan Gray",
      designation: "Diamond Player",
