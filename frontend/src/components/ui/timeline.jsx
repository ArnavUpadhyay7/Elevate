  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl font-semibold md:text-5xl mb-4 text-black dark:text-white max-w-4xl">
          Elevate your game 🎯
        </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Follow these expert-crafted steps to take your gameplay to the next level. Unlock your true potential and dominate every match with ease.
        </p>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-20 md:pt-28 md:gap-10">
            <div
